/* 탐험 콘텐츠 데이터
   ...
   발견일지 등재는 퀴즈를 풀었을 때, 그리고 발견 탐험(DISCOVERIES) 대상 동물을 사진으로 찾았을 때. */
...
/* 동물별 퀴즈 — 우리 가까이 가면 그 동물이 무작위로 내는 퀴즈.
   풀면(정답·오답 무관) 그 동물이 발견일지에 등재됨 — 발견 탐험 사진과 함께 등재의 두 경로 중 하나.
...
/* 발견 탐험 — 특정 스팟이 아니라 공원 전체를 돌며 찾기 (사진은 기기에만 저장).
   targets 동물을 사진으로 찾으면 발견일지에 등재된다(need를 넘겨 찾은 것도 인정) —
   퀴즈가 안 걸린 마을의 동물도 도감에 담을 수 있는 두 번째 경로. */
