/* 탐험 콘텐츠 데이터
   ...
   퀴즈·관찰(observe)의 animals: 그 활동의 주인공 동물 — 수행 시 발견일지에 등재됨.
   특정 동물이 주인공이 아닌 활동(예: '파충류' 일반)은 animals 생략 → 등재 없음. */
...
export const SPOTS = [
  {
    ...
    quizzes: {
      easy: [
        { q: '사자 무리에서 사냥을 주로 하는 건 누구일까요?', a: ['암사자들', '수사자', '아기 사자'], correct: 0, animals: ['lion'],
          explain: '사냥은 주로 암사자들이 힘을 합쳐서 해요. 수사자는 무리를 지키는 일을 맡아요.' },
        { q: '호랑이의 줄무늬는 모두 똑같을까요?', a: ['똑같다', '저마다 다르다'], correct: 1, animals: ['tiger'],
          explain: '호랑이 줄무늬는 사람의 지문처럼 한 마리 한 마리 모두 달라요!' },
      ],
      hard: [
        { q: '아시아코끼리의 임신 기간은 얼마나 될까요?', a: ['6개월', '12개월', '약 22개월'], correct: 2, animals: ['elephant'],
          explain: '코끼리는 약 22개월, 거의 2년 동안 아기를 품어요. 육지 동물 중 가장 긴 편이에요.' },
        { q: '재규어와 표범을 구별하는 방법은?', a: ['무늬 안에 점이 있다', '꼬리가 없다', '갈기가 있다'], correct: 0, animals: ['jaguar'],
  ...
  },
  {
    ...
    quizzes: {
      easy: [
        { q: '얼룩말 친구들의 줄무늬는 서로 똑같을까요?', a: ['똑같다', '저마다 다르다'], correct: 1, animals: ['zebra'],
          explain: '얼룩말 줄무늬도 저마다 달라요. 무늬로 서로를 알아본답니다.' },
        { q: '알파카는 어느 대륙에서 왔을까요?', a: ['아시아', '남아메리카', '아프리카'], correct: 1, animals: ['alpaca'],
          explain: '알파카는 남아메리카 안데스 산맥의 높은 곳에서 온 친구예요.' },
      ],
      hard: [
        { q: '붉은캥거루 아기는 태어날 때 얼마만 할까요?', a: ['콩알만 하다(약 2cm)', '강아지만 하다', '사람 아기만 하다'], correct: 0, animals: ['kangaroo'],
          explain: '갓 태어난 캥거루는 약 2cm! 스스로 엄마 주머니까지 기어 올라가 그 안에서 자라요.' },
        { q: '얼룩말이 무리를 지어 다니는 가장 큰 이유는?', a: ['맹수로부터 서로 지키려고', '심심해서', '길을 잘 몰라서'], correct: 0, animals: ['zebra'],
  ...
  },
  {
    ...
    quizzes: {
      easy: [
        { q: '미어캣이 두 발로 서서 하는 일은 무엇일까요?', a: ['망보기', '춤추기', '키 재기'], correct: 0, animals: ['meerkat'],
          explain: '미어캣은 번갈아 가며 두 발로 서서 하늘의 맹금류와 주변을 살피는 파수꾼이에요.' },
        { q: '수달이 헤엄을 잘 치는 비결은?', a: ['물갈퀴', '바퀴', '지느러미 꼬리'], correct: 0, animals: ['otter', 'euotter'],
          explain: '수달의 발가락 사이에는 물갈퀴가 있어서 물속에서 빠르게 움직일 수 있어요.' },
      ],
      hard: [
        { q: '작은발톱수달은 세계에서 가장 ___ 수달이에요.', a: ['작은', '큰', '빠른'], correct: 0, animals: ['otter'],
          explain: '작은발톱수달은 세계 수달 중 가장 작아요. 손재주가 좋아 조개도 잘 다룬답니다.' },
        { q: '포큐파인이 몸을 지키는 방법은?', a: ['가시를 세운다', '고약한 냄새를 뿜는다', '죽은 척한다'], correct: 0, animals: ['porcupine'],
  ...
  },
  {
    ...
    quizzes: {
      easy: [
        { q: '거북이는 어떤 동물일까요?', a: ['파충류', '포유류', '어류'], correct: 0, animals: ['tortoise', 'pancake'],
          explain: '거북·뱀·도마뱀은 모두 파충류! 몸이 비늘이나 딱딱한 껍질로 덮여 있어요.' },
        { q: '뱀은 눈꺼풀이 있을까요?', a: ['있다', '없다'], correct: 1, animals: ['python', 'cornsnake'],
      ...
      hard: [
        ...
        { q: '다람쥐원숭이의 긴 꼬리는 어디에 쓰일까요?', a: ['균형 잡기', '무기', '땅 파기'], correct: 0, animals: ['squirrelmonkey'],
  ...
  },
  {
    ...
    quizzes: {
      easy: [
        { q: '물개와 물범 중 겉으로 보이는 귀(귓바퀴)가 있는 쪽은?', a: ['물개', '물범'], correct: 0, animals: ['furseal', 'seal'],
          explain: '물개는 작은 귓바퀴가 겉으로 보여요. 물범은 귓구멍만 있답니다. 오늘 직접 확인해 봐요!' },
        { q: '물범이 가장 좋아하는 먹이는?', a: ['물고기', '풀', '과일'], correct: 0, animals: ['seal'],
          explain: '물범은 물고기를 잡아먹는 사냥꾼이에요. 수염으로 물의 흐름을 느껴 먹이를 찾아요.' },
      ],
      hard: [
        { q: '점박이물범은 우리나라 바다에도 살까요?', a: ['산다 (백령도)', '살지 않는다'], correct: 0, animals: ['seal'],
          explain: '점박이물범은 서해 백령도에 사는 우리나라 천연기념물(제331호)이에요!' },
        { q: '물개가 헤엄칠 때 주로 쓰는 것은?', a: ['앞지느러미', '뒷지느러미', '꼬리'], correct: 0, animals: ['furseal'],
  ...
  },
  {
    ...
    quizzes: {
      easy: [
        { q: '긴팔원숭이는 팔과 다리 중 어느 쪽이 더 길까요?', a: ['팔', '다리', '똑같다'], correct: 0, animals: ['ygibbon', 'sgibbon'],
      ...
      hard: [
        { q: '일본원숭이는 겨울에 무엇으로 유명할까요?', a: ['온천욕', '스키', '겨울잠'], correct: 0, animals: ['macaque'],
  ...
  },
  {
    ...
    quizzes: {
      easy: [
        { q: '펭귄은 하늘을 날 수 있을까요?', a: ['날 수 있다', '날 수 없다'], correct: 1, animals: ['penguin'],
          explain: '펭귄은 하늘을 날지 못해요. 대신 날개를 지느러미처럼 써서 물속을 나는 듯 헤엄쳐요!' },
        { q: '펠리컨 부리 아래 큰 주머니는 어디에 쓰일까요?', a: ['물고기 담기', '모자', '노래 부르기'], correct: 0, animals: ['pelican'],
          explain: '펠리컨은 부리 주머니를 그물처럼 써서 물고기를 물과 함께 퍼 담아요.' },
      ],
      hard: [
        { q: '두루미는 우리나라 천연기념물일까요?', a: ['맞다 (제202호)', '아니다'], correct: 0, animals: ['crane'],
          explain: '두루미는 천연기념물 제202호이자 멸종위기종이에요. 예부터 장수의 상징이었죠.' },
        { q: "자카스펭귄의 '자카스'는 무슨 뜻에서 왔을까요?", a: ['당나귀 울음소리를 닮아서', '몸이 작아서', '빨라서'], correct: 0, animals: ['penguin'],
