...
function localAnswer(q) {
  ...
  const rules = [
    ...
    [/발견일지|도감|등재|채우/, '📔 발견일지는 두 가지로 채워져! ① 🎓 퀴즈 풀기 — 틀려도 괜찮아, 배우면 성공이거든. ② ✨ 발견 탐험에 나온 친구를 📷 사진으로 찾기! 둘 다 해보자!'],
    [/스토리|리캡|공유/, '내 기록 → 🌟 오늘의 리캡에서 "🎬 오늘 탐험 끝!"을 눌러봐. 오늘 만난 동물들이 스토리로 착착 넘어가고, 마음에 드는 장면은 📤 이미지로 공유할 수 있어!'],
    [/사진/, '동물 친구를 톡 누르고 📷 사진 찍기를 하면 오늘의 리캡 스토리에 나와! ✨ 발견 탐험에 나온 친구를 찍으면 📔 발견일지에도 담긴단다. 사진은 네 휴대폰 밖으로 나가지 않으니 안심해. 📱'],
